 ...
 * @author KLphu
 */
public class MonAnGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(jTableModel1 = new javax.swing.table.DefaultTableModel(
            new String [] {
                "STT", "Mã món", "Tên món", "Giá tiền","Loại","Kích thước", "Khuyến Mãi","Trạng thái", "Ghi Chú"
            }
            , 0));
    ...
    jPanel3.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 130, -1, -1));
    ...
    jPanel3.add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 120, 320, 40));

    jTextField2.setEditable(false);
    jTextField2.setEnabled(false);
    jTextField2.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
    jPanel3.add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 60, 320, 40));

    jLabel4.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
    jLabel4.setText("Trạng thái: ");
    jPanel3.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(890, 70, -1, -1));
    ...
    jPanel3.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(1030, 230, -1, -1));
    ...
    jPanel3.add(jTextField4, new org.netbeans.lib.awtextra.AbsoluteConstraints(1080, 230, 380, 40));

    jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] {"Bình Thường","Tạm Ngưng " }));
    jComboBox1.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            jComboBox1ActionPerformed(evt);
        }
    });
    jPanel3.add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1090, 60, 320, 40));

    jTextField3.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
    jPanel3.add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(1090, 120, 320, 40));

    jLabel3.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
    jLabel3.setText("Khuyến mãi (%):");
    jPanel3.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(890, 130, -1, -1));
    ...
    jPanel3.add(jButton7, new org.netbeans.lib.awtextra.AbsoluteConstraints(930, 230, 70, 40));
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        MonAn_DAO ds = new MonAn_DAO();
        List<MonAn> list = ds.fin(sdt);
        count = 0;
        for (MonAn s : list)
        {
            ...
            count++;
            String [] r = {"" + count, s.getMaMonAn(), s.getTenMonAn(),dfm.format(s.getGiaTien()), s.getLoai(), s.getSize(),"" + s.getKhuyenMai(), s.getTrangThai(), s.getGhiChu()};
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (r >= 0){
            ...
            if (dsma.upd(km, tt, ma))
            {
                jTable1.setValueAt(tt, r, 7); 
                jTable1.setValueAt(km, r, 6);
            }
        }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        jTextField3.setText(jTableModel1.getValueAt(r, 6).toString());
        jComboBox1.setSelectedItem(jTableModel1.getValueAt(r, 7).toString());
    }//GEN-LAST:event_jTable1MouseClicked
    
    private void docdulieu(){
        MonAn_DAO ds = new MonAn_DAO();
        List<MonAn> list = ds.getall();
        count = 0;
        for (MonAn s : list)
        {
            SimpleDateFormat fm = new SimpleDateFormat("dd/MM/yyyy");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MonAnGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
